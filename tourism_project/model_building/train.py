...
# One-hot encode for categorical type and scale numeric features
numeric_features = ["Age", "CityTier",
                     "MonthlyIncome", "NumberOfChildrenVisiting", "OwnCar", "NumberOfPersonVisiting", "PitchSatisfactionScore", "PreferredPropertyStar", "Passport", "NumberOfTrips", "DurationOfPitch", "NumberOfFollowups"]
categorical_features = ["TypeofContact", "Gender", "Occupation", "ProductPitched", "MaritalStatus", "Designation"]
